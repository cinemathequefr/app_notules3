...
const getFullCode = {
  ...
  prog: function (progConfig) {
    try {
      return [`PROG${progConfig.idProg}`, progConfig.titre] // Code de la programmation, eg. "PROG60 Juin-juillet 2019"
    } catch (e) {
  ...
  cycle: function (progConfig, idCycle) {
    try {
      ...
      return [`PROG${progConfig.idProg}_CYCL${idCycle}`, `${titreCycle}`]
    } catch (e) {
